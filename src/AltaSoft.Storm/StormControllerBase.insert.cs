...
public abstract partial class StormControllerBase
{
        ...
        where T : IDataBindable
    {
        ...
        GenerateInsertSql(command, value, ref paramIndex, -1, queryParameters.TableHints, sb);
        ...
        where T : IDataBindable
    {
        ...
        {
            GenerateInsertSql(command, value, ref paramIndex, -2, queryParameters.TableHints, sb);
        }
    ...
    private void GenerateInsertSql(IVirtualStormDbCommand command, IDataBindable value, ref int paramIndex, int index, StormTableHints tableHints, StringBuilder sb)
    {
        ...
        var (masterPkColumnNames, masterPkParamNames) = GenerateInsertOneRowSql(command, masterValues, true, ref paramIndex, null, index, tableHints, sb);
    ...
    private (List<string>? masterPkColumnNames, List<string>? masterPkParamNames)
        GenerateInsertOneRowSql(IVirtualStormDbCommand command, IReadOnlyList<(StormColumnDef column, object? value)> columnValues,
            bool returnPkInfo, ref int paramIndex, string? indent, int index, StormTableHints tableHints, StringBuilder sb)
    {
        var pid = paramIndex;
        var autoIncColumn = __GetAutoIncColumn();
