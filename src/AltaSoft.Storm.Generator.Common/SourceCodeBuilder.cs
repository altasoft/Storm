...
public sealed class SourceCodeBuilder
{
    ...
    /// </summary>
    public static readonly string NewLineString = GetNewLineString();

    /// <summary>
    /// Represents the length of a new line character sequence.
    /// </summary>
    internal static readonly int s_newLineLength = NewLineString.Length;
    ...
    /// <returns>A reference to this <see cref="SourceCodeBuilder"/> instance.</returns>
    public SourceCodeBuilder AppendLines(string lines) => AppendLines(lines.Split([NewLineString], StringSplitOptions.None));

    /// <summary>
    /// Appends multiple lines of code to the source code builder with a specified prefix.
    /// </summary>
    /// <param name="prefix">The prefix to add to each line.</param>
    /// <param name="lines">The lines of code to append.</param>
    /// <returns>
    /// The updated SourceCodeBuilder instance with the appended lines.
    /// </returns>
    public SourceCodeBuilder AppendLines(string prefix, string lines)
    {
        return AppendLines(lines.Split([NewLineString], StringSplitOptions.None).Select(x => prefix + x));
    }
