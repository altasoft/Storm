...
public sealed class DatabaseHelper
{
    ...
    public static User NewUser(int id)
    {
        return new User
        {
            ...
            CurrencyId = "USD",
            Dates = new List<DatePair> {
                new() { Date1 = DateOnly.FromDateTime(DateTime.Today), Date2 = DateOnly.FromDateTime(DateTime.Today.AddDays(Random.Shared.Next(100))) },
                new() { Date1 = DateOnly.FromDateTime(DateTime.Today.AddDays(2)), Date2 = null }
            },
