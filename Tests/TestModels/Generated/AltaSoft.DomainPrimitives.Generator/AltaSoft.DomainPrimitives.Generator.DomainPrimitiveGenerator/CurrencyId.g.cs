...
[TypeConverter(typeof(CurrencyIdTypeConverter))]
[UnderlyingPrimitiveType(typeof(string))]
[DebuggerDisplay("{_value}")]
public partial class CurrencyId : IEquatable<CurrencyId>
        , IComparable
        , IComparable<CurrencyId>
        , IParsable<CurrencyId>
        , IConvertible
{
    /// <inheritdoc/>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CurrencyId"/> class by validating the specified <see cref="string"/> value using <see cref="Validate"/> static method.
    /// </summary>
    /// <param name="value">The value to be validated.</param>
    public CurrencyId(string value) : this(value, true)
    {
    }

    private CurrencyId(string value, bool validate) 
    {
        if (validate)
        {
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// </summary>
    /// <param name="value">The value to create CurrencyId from</param>
    /// <param name="result">When this method returns, contains the created CurrencyId if the conversion succeeded, or null if the conversion failed.</param>
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value, [NotNullWhen(true)] out CurrencyId? result)
    {
    ...
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value, [NotNullWhen(true)]  out CurrencyId? result, [NotNullWhen(false)]  out string? errorMessage)
    {
    ...
    public int CompareTo(object? obj)
    {
        ...
        if (obj is CurrencyId c)
            return CompareTo(c);

        throw new ArgumentException("Object is not a CurrencyId", nameof(obj));
    }
    ...
    /// <summary>
    /// Implicit conversion from <see cref = "string"/> (nullable) to <see cref = "CurrencyId"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator CurrencyId?(string? value) => value is null ? null : new(value);

    /// <summary>
    /// Implicit conversion from <see cref = "CurrencyId"/> (nullable) to <see cref = "string"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator string?(CurrencyId? value) => value is null ? null : (string?)value._valueOrThrow;

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CurrencyId Parse(string s, IFormatProvider? provider) => s;

    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out CurrencyId result)
    {
        if (s is null)
        {
            result = default;
        ...
        return CurrencyId.TryCreate(s, out result);
    }
