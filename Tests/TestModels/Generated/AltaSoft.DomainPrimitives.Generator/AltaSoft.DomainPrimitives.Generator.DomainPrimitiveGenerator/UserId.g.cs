...
using AltaSoft.Storm.TestModels.DomainTypes.Converters;
...
public readonly partial struct UserId : IEquatable<UserId>
        , IComparable
        , IComparable<UserId>
        , IAdditionOperators<UserId, UserId, UserId>
        , ISubtractionOperators<UserId, UserId, UserId>
        , IMultiplyOperators<UserId, UserId, UserId>
        , IDivisionOperators<UserId, UserId, UserId>
        , IModulusOperators<UserId, UserId, UserId>
...
#endif
{
    ...
    private int _valueOrThrow => _isInitialized ? _value : throw InvalidDomainValueException.NotInitializedException(typeof(UserId));
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UserId"/> class by validating the specified <see cref="int"/> value using <see cref="Validate"/> static method.
    /// </summary>
    /// <param name="value">The value to be validated.</param>
    public UserId(int value) : this(value, true)
    {
    }

    private UserId(int value, bool validate) 
    {
        if (validate)
        {
    ...
    public static bool TryCreate(int value, [NotNullWhen(true)] out UserId? result)
    {
    ...
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(int value, [NotNullWhen(true)]  out UserId? result, [NotNullWhen(false)]  out string? errorMessage)
    {
    ...
    public void ValidateOrThrow(int value)
    {
        ...
        if (!result.IsValid)
        	throw new InvalidDomainValueException(result.ErrorMessage, typeof(UserId), value);
    }
    ...
    public int CompareTo(object? obj)
    {
        ...
        throw new ArgumentException("Object is not a UserId", nameof(obj));
    }
    ...
    /// <summary>
    /// Implicit conversion from <see cref = "int"/> to <see cref = "UserId"/>
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator UserId(int value) => new(value);

    /// <summary>
    /// Implicit conversion from <see cref = "int"/> (nullable) to <see cref = "UserId"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator UserId?(int? value) => value is null ? null : new(value.Value);

    /// <summary>
    /// Implicit conversion from <see cref = "UserId"/> to <see cref = "int"/>
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator int(UserId value) => (int)value._valueOrThrow;

    /// <summary>
    /// Implicit conversion from <see cref = "UserId"/> (nullable) to <see cref = "int"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator int?(UserId? value) => value is null ? null : (int?)value.Value._valueOrThrow;

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UserId operator +(UserId left, UserId right) => new(left._valueOrThrow + right._valueOrThrow);
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator <(UserId left, UserId right) => left._valueOrThrow < right._valueOrThrow;
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UserId Parse(string s, IFormatProvider? provider) => int.Parse(s, provider);
