...
/// <summary>
/// JsonConverter for <see cref = "CurrencyId"/>
/// </summary>
internal sealed class CurrencyIdJsonConverter : JsonConverter<CurrencyId>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public override CurrencyId ReadAsPropertyName(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        try
        {
    ...
    /// <inheritdoc/>
    public override void WriteAsPropertyName(Utf8JsonWriter writer, CurrencyId value, JsonSerializerOptions options)
    {
