...
public abstract partial record TrackableObject : ITrackingObject
{
    ...
    private void __PropertySet_StrValue(ref string newValue, ref string oldValue) { if (_isChangeTrackingActive && oldValue != newValue) _changeTrackingStateMachine!.PropertyChanged(nameof(StrValue), newValue); }
    private void __PropertySet_NullStrValue(ref string? newValue, ref string? oldValue) { if (_isChangeTrackingActive && oldValue != newValue) _changeTrackingStateMachine!.PropertyChanged(nameof(NullStrValue), newValue); }
    ...
    private void __PropertySet_NullIntValue(ref int? newValue, ref int? oldValue) { if (_isChangeTrackingActive && oldValue != newValue) _changeTrackingStateMachine!.PropertyChanged(nameof(NullIntValue), newValue); }
    private void __PropertySet_CustomerIdValue(ref AltaSoft.Storm.TestModels.VeryBadNamespace.CustomerId newValue, ref AltaSoft.Storm.TestModels.VeryBadNamespace.CustomerId oldValue) { if (_isChangeTrackingActive && oldValue != newValue) _changeTrackingStateMachine!.PropertyChanged(nameof(CustomerIdValue), newValue); }
