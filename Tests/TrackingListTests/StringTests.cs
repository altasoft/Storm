...
public class StringTests
{
    ...
    {
        // Arrange
        var trackingList = new TrackingList<string>();
        const string item = "Test string";
    ...
    public void Clear_ShouldTrackAllItemsAsDeleted()
    {
        // Arrange
        var trackingList = new TrackingList<string>();
        const string item1 = "Test string";
        const string item2 = "Test string 2";
    ...
    public void ReplaceAtIndex_ShouldTrackDeletedAndInsertedItem()
    {
        // Arrange
        var trackingList = new TrackingList<string>();
        const string originalItem = "Original";
